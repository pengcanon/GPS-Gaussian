...
def single_head_split_window_attention(q, k, v,
    ...
    """#check if split window is hornered. to delete this print statement later
    print(f"[2D-ATTN]  splits={num_splits:2d}  tokens={q.shape[1]:6d}")"""
...
def single_head_split_window_attention_1d(q, k, v,
    ...
    """#check if split window is hornered. to delete this print statement later
    print(f"[1D-ATTN]  splits={num_splits:2d}  tokens={q.shape[1]:4d} "
          f"  batches={q.shape[0]:5d}")"""
